...
function ProfilePage() {
  ...
  const getProfile = async () => {
    try {
      const response = await axios.get(`http://35.175.254.24:4000/api/accounts/profile/${username}`, {
      });
  ...
  const updateAboutMe = async () => {
    try {
      await axios.patch(`http://35.175.254.24:4000/api/accounts/about-me`, {
  ...
  const getUserEncounters = async () => {
    try {
      const response = await axios.get(`http://35.175.254.24:4000/api/encounters/${username}`, { // sends get request to the backend thru URL
      });
  ...
  const deleteEncounter = async (encounter_id: string) => {
    ...
    try {
      ...
      const response = await axios.delete(`http://35.175.254.24:4000/api/encounters/encounter`, {
        headers: {
  ...
  const getUserPosts = async () => {
    try {
      const response = await axios.get(`http://35.175.254.24:4000/api/forums/${username}`);
