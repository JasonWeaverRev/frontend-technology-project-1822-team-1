...
function Comments({
  ...
  const [deletingCommentTime, setDeletingCommentTime] = useState<string | null>(
    null
  );
  ...
  return (
    <>
      <div className="comment-bg row">
        {" "}
        {/* COMMENT CONTAINER */}
        <div className="col-1 d-flex flex-column justify-content-top align-items-center mt-3">
          {" "}
        ...
        <div className="col-11 landing-page-text-format">
          {" "}
